  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(124,102,255,.55) 0%, transparent 60%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(169,150,255,.45) 0%, transparent 60%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(124,102,255,.4) 0%, transparent 60%)",
        }}
      />
    </div>
  );
